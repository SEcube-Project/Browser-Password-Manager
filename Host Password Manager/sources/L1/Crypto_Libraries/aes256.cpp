/**
  ******************************************************************************
  * File Name          : aes256.cpp
  * Description        : Low level AES-256 implementation.
  ******************************************************************************
  *
...
int32_t B5_CmacAes256_Finit (B5_tCmacAesCtx *ctx, uint8_t *rSignature)
{
    ...
    /* @matteo: added curly braces to for loop.
     * does the B5_Aes256_Update belong to the for
     * or not? In the original code it should not. */
    for (i=0; i<B5_AES_BLK_SIZE; i++){
        ctx->C[i] ^= MN[i];
    }
