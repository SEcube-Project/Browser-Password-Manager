...
This tutorial implies that a working version of Eclipse for C/C++ and the AC6 Tools are available.
Once the SECube has been connected to the Host computer via both the ST-Link/v2 programmer and the USB connection, the firmware can be flashed.

The latest firmware version has been already compiled and available at ``\textit{SEcube USBStick Firmware/Project/Eclipse/USBStick/Debug/USBStick.elf}" but it is possible to import the project into Eclipse and recompile it.
